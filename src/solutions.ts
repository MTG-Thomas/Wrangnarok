...
import { digestSaga, echoSaga, Fault, hash, ninjaSaga, object, smokeSaga, UUID } from "./domain";
...
const CODE_SAGAS: readonly CatalogSaga[] = [echoSaga, ninjaSaga, digestSaga, smokeSaga];
